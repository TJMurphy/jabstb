...
What an interaction means biologically is what you have to judge scientifically. I know a bit about pharmacology. Let's assume that gene encodes a drug metabolizing protein. The loss of the protein could lead to a larger blood glucose-lowering effect of the drug, because the drug would not be strongly metabolized. 

Rewinding the clock even further, let's assume I suspected that all along. The experimental design is to assess, indirectly, whether that gene's protein metabolizes that drug. An two way ANOVA interaction effect would be consistent with that hypothesis. 
