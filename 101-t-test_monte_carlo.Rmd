...
### Change n to zero in on the power you want
...
The planning is based on [some mouse phenome data in a diet-induced obesity study in a fancy mouse strain](https://phenome.jax.org/projects/Jaxwest7), which is a common model for type II diabetes. 
