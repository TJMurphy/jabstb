...
The light turned on for me during Gary's *Experimenal Design* course. That's when the fog of mathematical statistics cleared enough so I could finally "get" the pragmatic value of statistics for the researcher. 
...
The problem my classmates shared, which was not one that really affected me, is having only a single growing or mating season by which to run a fully replicated experiment.
