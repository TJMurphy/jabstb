...
Although the natural log throughout this chapter, this reciprocal relationship of lognormal distributed variables and their log transformations applies for any positive log base value greater than 1. For example, $X=10^Z$ is lognormal when $Z=log10(X)$ is normal.
...
```{r, fig.cap="Left panel: Simulated lognormal distributed fluorescence data. The units are fluorescence in arbitray light units. Note their skewness. Right panel: The same data after log transformation. Note the symmetry. The plot on the right has a mean of ~ 0.8 and sd ~1.2, in units of log_fluorscence."}
set.seed(8675309)
