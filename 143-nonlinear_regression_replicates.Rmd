...
### Calculate half-lives and perform t-test
...
Reject the null hypothesis. The data indicate....

#### Write up

**Exposure to cigarette smoke about doubles the rate of theophylline metabolism in rat microsomes, from 16 +/- 0.9 min to 29 +/- 0.6 min (mean +/- SD, 95% confidence interval of the difference is 11.6 to 15.3 min, unpaired t-test, p=3.4e-5).**
